...
export const metadata: Metadata = {
  title: "Raymond Design Studio",
  description: "Raymond Design Studio offers innovative and personalized design solutions for your projects.",
  openGraph: {
    title: "Raymond Design Studio",
    description: "Innovative and personalized design solutions.",
    siteName: "Raymond Design Studio",
    type: "website",
  },
};
